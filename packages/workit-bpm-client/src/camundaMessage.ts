...
import { getVariablesWhenChanged, ProxyFactory } from '@mkostka/workit-core';
import { FailureException, ICamundaService, IMessage, IVariablePayload, IVariables }from '@mkostka/workit-types';
