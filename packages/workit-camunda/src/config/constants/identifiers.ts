...
import { SERVICE_IDENTIFIER as CAMUNDA_BPM_IDENTIFIER } from '@mkostka/workit-bpm-client';
import { SERVICE_IDENTIFIER as ZEEBE_IDENTIFIER } from '@mkostka/workit-zeebe-client';
